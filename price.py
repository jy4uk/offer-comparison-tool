...
URL2 = "https://www.payscale.com/research/US/Job="
job = input("job name? ")
job = job.replace(' ', "_")
URL2 = URL2 + job + "/Salary"
...
def get_median_salary():
    salary = int(soup2.find("div", {"class" : "spotlight__value"}).get_text().strip(' $').replace(',', ''))
    return salary
